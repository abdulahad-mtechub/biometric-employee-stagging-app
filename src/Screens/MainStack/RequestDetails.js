...
const RequestDetails = ({route, navigation}) => {
  ...
  console.log('RequestDetails token:', token);
  console.log('RequestDetails route.params:', JSON.stringify(item, null, 2));
  ...
  const RequestDetail = [
    ...
    {label: 'Description', value: ['I need urgent loan to buy the house']},
  ];
  const AttendenceRequestDetail = [
    {label: 'Type', value: 'Leave'},
    {label: 'From - To', value: '15 May, 2025 - 18 May, 2054'},
    {label: 'Total Leaves', value: '3'},
    {label: 'Description', value: ['I need urgent loan to buy the house']},
  ];
    ...
    <View style={styles.container}>
      <ScrollView style={{flex: 1}}>
        ...
        <RequestDetailsCard
          ...
          details={
            isInformation || isDocument
              ? InformationRequestsDetails
              : isAttendance
              ? AttendenceRequestDetail
              : isExpense
              ? RequestDetail
              : []
          }
      ...
      <View style={styles.btnContainer}>
        {isExpense || isAttendance ? (
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <CustomButton
              text={isDocument ? 'Upload Document' : 'Add Comment'}
              onPress={() => navigation.goBack()}
              textStyle={styles.SkipButtonText}
              containerStyle={[styles.SkipButton, {width: '45%'}]}
            />
            <CustomButton
              text={isDocument ? 'Add Comments' : 'Change Status'}
              onPress={() => {}}
              textStyle={styles.continueButtonText}
              containerStyle={[styles.continueButton, {width: '45%'}]}
            />
          </View>
        ) : null}
      </View>
